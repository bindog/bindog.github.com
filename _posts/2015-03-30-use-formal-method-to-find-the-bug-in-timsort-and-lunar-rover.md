...
![timsort table](https://github.com/bindog/bindog.github.com/assets/8023481/316cb34c-dea5-4d42-9a8d-24f5eb374559)
...
![timsort run](https://github.com/bindog/bindog.github.com/assets/8023481/5a6c010d-d1f8-4fa8-b242-939d3064c9c5)
...
![timsort_ex1](https://github.com/bindog/bindog.github.com/assets/8023481/15928709-6af4-4787-910d-7b27e0eb9e54)

注意，此时栈顶的run是不满足约束条件的，因为此时runLen[0] < runLen[1]，所以要对这两个run进行归并，当然这个过程使用的是归并排序。

如果遇到有序片段长度小于minrun，则要进行补齐，如下图所示

![timsort_ex2](https://github.com/bindog/bindog.github.com/assets/8023481/6c434ff8-df53-421d-b707-ccc781190103)

注意，此时栈顶run是满足约束条件的，10 > 5 + 4，5 > 4，因此不需要进行归并。

最后数组元素个数不足minrun了，只能作为一个run了

![timsort_ex3](https://github.com/bindog/bindog.github.com/assets/8023481/562a73e9-819e-40de-812d-d0c867a5bfc2)

此时栈顶的run又不满足约束条件了，5 < 4 + 2，所以需要进行归并。后续过程如下图所示

![timsort_ex4](https://github.com/bindog/bindog.github.com/assets/8023481/d0aea0a9-fe13-4752-8837-2954bee9217d)
