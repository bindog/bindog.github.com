...
-\_-怎么说呢，如果`n`比较小的话，采用试除法当然是非常高效快捷的。但是当`n`**很大**的时候，这个算法可就行不通了，以RSA1024为例，当公钥为``时，两个质因数分别为`e5a111a219c64f841669400f51a54dd4e75184004f0f4d21c6ae182cfb528652a02d6d677a72b564c505b1ed42a0c648dbfe14eb66b04c0d60ba3872826c32e7`和`98cb760764484e29245521be08e7f38edeebfca8427149524ba7f4735e1d5f3a45d585cb3722ff4c07c19165be738311dc346a914966f5b311416fed3b425079`，转换为十进制分别为`12026655772210679470465581609002525329245773732132014742758935511187863487919026457076252932048619706498126046597130520643092209728783224795661331197604583`和`8002511426596424351829267099531651390448054153452321185350746845306277585856673898048740413439442356860630765545600353049345324913056448174487017235828857`，这是一个`155`位数和一个`154`位数，都在`2`的`511`次方左右(-\_-||)，如果看到这里你还觉得试除法可行的话，我只想问：你家是有超算么？！
...
本来想展示一个`Java`版的程序，结果发现`Java`中的`java.math.BigInteger`已经内置了Miller-Rabin素性检测函数
...
* 3.检测该数能否被`10000`以下的素数（共`1228`个）整除，这样可以快速排除许多合数，节省时间
