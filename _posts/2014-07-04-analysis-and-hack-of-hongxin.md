...
![大酒神从零Rap之我不能忍](http://lc-cf2bfs1v.cn-n1.lcfile.com/449685a798cc1094c3fc.png)
...
![红杏主界面](http://lc-cf2bfs1v.cn-n1.lcfile.com/1b19fcfee2801d7274b8.png)

红杏的具体使用方法官网已经讲得很详细了，由于我是非VIP用户，因此不能添加自己的科学上网列表，不过谷歌学术已经可以正常访问了~

![熟悉的谷歌学术又回来了](http://lc-cf2bfs1v.cn-n1.lcfile.com/a54aafd3d74a77058d28.png)

# 0x02 红杏的原理

那么红杏到底是怎么工作的呢，它的原理是什么呢？下面我们先通过`Wireshark`一探红杏背后的秘密。启动`Wireshark`进行抓包，然后用`Chrome`访问Google，在`Wireshark`中得到如下结果

![Wireshark抓包结果](http://lc-cf2bfs1v.cn-n1.lcfile.com/ea15bebc9b92823cf2b1.png)
...
![红杏的登录界面](http://lc-cf2bfs1v.cn-n1.lcfile.com/8f823b3eaa51f3e92107.png)

然后按F12打开开发人员工具，切换到Network选项卡，输入用户名之后点击登录，得到如下结果

![验证用户名的数据包](http://lc-cf2bfs1v.cn-n1.lcfile.com/a7e8ad843f5d2ed55f19.png)

响应非常简单`{"exists": true}`，表示该用户存在
接着输入密码，注意勾选`Preserve log`，否则页面跳转之后就无法看到数据包了，登录成功之后得到如下数据包

![验证用户名和密码的数据包](http://lc-cf2bfs1v.cn-n1.lcfile.com/98ea03510ca21e4cb5c1.png)
...
![没有代理的数据包](http://lc-cf2bfs1v.cn-n1.lcfile.com/a636fb7858beead964af.png)
...
![解压后的一些文件](http://lc-cf2bfs1v.cn-n1.lcfile.com/d26601a4d32cf5332521.png)
...
![动态获取到代理服务器地址](http://lc-cf2bfs1v.cn-n1.lcfile.com/88d4112c6635ae2bf190.png)
...
![data图片](http://lc-cf2bfs1v.cn-n1.lcfile.com/1c10854051f08dedc221.png)
...
![破解成功图](http://lc-cf2bfs1v.cn-n1.lcfile.com/54d09a8011cd3c5950f5.png)
...
![过程图](http://lc-cf2bfs1v.cn-n1.lcfile.com/aaa6fdcf69e882a0da17.png)
